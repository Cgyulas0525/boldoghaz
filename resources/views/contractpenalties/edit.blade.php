...
@section('content')
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-12">
                    <h1>{{ $contractpenalty->contract->contractnumber }} számú szerződés kötbér</h1>
                </div>
            </div>
        </div>
    </section>
    ...
    <div class="content px-3">
        ...
        <div class="card">
            ...
            {!! Form::model($contractpenalty, ['route' => ['contractpenalties.update', $contractpenalty->id], 'method' => 'patch']) !!}
