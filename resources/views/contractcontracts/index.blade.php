        ...
        $(function () {
            ...
            var table = $('.partners-table').DataTable({
                ...
                columns: [
                    ...
                    {title: 'Összed', data: 'amount', render: $.fn.dataTable.render.number( '.', ',', 0), sClass: "text-right", width:'150px', name: 'amount'},
                    ...
                    {title: 'Teljesítési idő', data: 'settlementdate', render: function (data, type, row) { return data ? moment(data).format('YYYY.MM.DD') : ''; }, sClass: "text-center", width:'150px', name: 'settlementdate'},
                ],
                buttons: []
            });
