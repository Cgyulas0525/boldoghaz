...
<div class="form-group col-sm-6">
    ...
    @if (isset($partnertypes->id))
        ...
        <div class="form-group col-sm-12">
            ...
            {!! Form::hidden('parent_id', $partnertypes->id, ['class' => 'form-control']) !!}
        </div>
    @else
        <div class="form-group col-sm-12">
            {!! Form::label('parent_id', 'Felettes:') !!}
            {!! Form::select('parent_id', \App\Http\Controllers\Dictionaries\PartnertypesController::DDDW(), null,
    ...
    <script type="text/javascript">
        $(function () {
            ...
            var table = $('.partners-table').DataTable({
                ...
                paging: false,
                // order: [[1, 'asc']],
                ajax: "{{ route('ptChildIndex', isset($partnertypes->id) ? $partnertypes->id : 0 ) }}",
                columns: [
                    {
                        title: '<a class="btn btn-primary" title="Felvitel" href="{!! route('ptChildCreate', $partnertypes->id) !!}"><i class="fa fa-plus-square"></i></a>',
                        data: 'action',
                        sClass: "text-center",
                        width: '200px',
                        name: 'action',
